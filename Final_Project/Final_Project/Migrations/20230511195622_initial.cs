        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkData = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prgm = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Messages",
                columns: new[] { "id", "Body", "Messageid", "ParentID", "Title", "UserName", "isReply" },
                values: new object[,]
                {
                    { -6, "Body1", null, 0, "Message5", "Null", false },
                    { -5, "Body5", null, 0, "Message1", "Null", false },
                    { -4, "Body4", null, 0, "Message2", "Null", false },
                    { -3, "Body3", null, 0, "Message3", "Null", false },
                    { -2, "Body2", null, 0, "Message4", "Null", false },
                    { -1, "Body1", null, 0, "Message5", "Null", false }
                });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "id", "Prgm", "Program", "about", "description", "name", "number" },
                values: new object[,]
                {
                    { 1, "FRC", 0, "About", "Description", "Name", "Number" },
                    { 2, "FRC", 1, "About", "Description", "Name", "Number" },
                    { 3, "FRC", 1, "About", "Description", "Name", "Number" },
                    { 4, "FRC", 1, "About", "Description", "Name", "Number" },
                    { 5, "FRC", 1, "About", "Description", "Name", "Number" }
                });
